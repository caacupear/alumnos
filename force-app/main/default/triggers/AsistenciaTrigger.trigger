trigger AsistenciaTrigger on Asistencia__c (before insert,before update, before delete, 
    after insert, after update, after delete,after undelete) {

    TriggerHandler handler = new AsistenciaTriggerHandler(Trigger.isExecuting, Trigger.size);
