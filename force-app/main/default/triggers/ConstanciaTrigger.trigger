trigger ConstanciaTrigger on Constancia__c (before insert,before update, before delete, 
    after insert, after update, after delete,after undelete) {

    TriggerHandler handler = new ConstanciaTriggerHandler(Trigger.isExecuting, Trigger.size);
