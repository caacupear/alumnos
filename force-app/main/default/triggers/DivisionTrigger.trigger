trigger DivisionTrigger on Division__c (before insert,before update, before delete, 
                                   after insert, after update, after delete,after undelete) {

    TriggerHandler handler = new DivisionTriggerHandler(Trigger.isExecuting, Trigger.size);
