trigger  EvaluacionTrigger on Evaluacion__c (before insert,before update, before delete, 
    after insert, after update, after delete,after undelete) {

    TriggerHandler handler = new EvaluacionTriggerHandler(Trigger.isExecuting, Trigger.size);
