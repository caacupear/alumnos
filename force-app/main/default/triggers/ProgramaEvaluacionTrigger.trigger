trigger ProgramaEvaluacionTrigger on ProgramaEvaluacion__c (before insert,before update, before delete, 
    after insert, after update, after delete,after undelete) {

    TriggerHandler handler = new ProgramaEvaluacionTriggerHandler(Trigger.isExecuting, Trigger.size);
